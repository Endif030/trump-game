...
export const STORY_LEVELS: StoryLevel[] = [
  {
    ...
    options: [
      { 
        ...
        results: { 
          assetsChange: 500000000, 
          prestigeChange: -12, 
          investigationChange: 8, 
          insiderTrading: true, 
          description: { 
            zh: '你"恰好"在宣布前调整了投资组合。当关税消息引发市场恐慌时，你的做空头寸带来了5亿美元收益。华尔街日报开始质疑"巧合"的频率。', 
            en: 'You "happened" to adjust your portfolio before the announcement. When tariff news sparked panic, your short positions gained $500M. The WSJ starts questioning the frequency of such "coincidences".' 
          } 
        } 
      },
      { 
        ...
        results: { 
          assetsChange: 200000000, 
          prestigeChange: -6, 
          investigationChange: 4, 
          insiderTrading: true, 
          description: { 
            zh: '你发布了一条模棱两可的帖子，市场立刻震荡。在其他人还在解读你的"covfefe"时刻，你已经精准抄底。2亿美元入账，虽然有人质疑这是否算"政策透明"。', 
            en: 'You posted something ambiguous, markets immediately shook. While others decoded your "covfefe" moment, you bought the dip. $200M gained, though some question if this counts as "policy transparency".' 
          } 
        } 
      },
      { 
  ...
  },
  {
    ...
    options: [
      { 
        ...
        results: { 
          assetsChange: 2000000000, 
          prestigeChange: -10, 
          investigationChange: 15, 
          insiderTrading: true, 
          description: { 
            zh: '你公开支持法案后，比特币价格暴涨40%。家族持仓浮盈20亿美元。但SEC主席的眼神变得耐人寻味，几家媒体开始深挖""。', 
            en: 'After your public support, Bitcoin surged 40%. Family holdings gained $2B. But the SEC Chairman\'s gaze became meaningful, and media started digging into "coincidances".' 
          } 
        } 
      },
      { 
        ...
        results: { 
          assetsChange: 800000000, 
          prestigeChange: -3, 
          investigationChange: 5, 
          insiderTrading: true, 
          description: { 
            zh: '你在幕后为法案疏通关系，同时保持公开中立。币圈感恩你的"默默支持"，你的钱包也鼓了起来。8亿美元入账。这种方式风险更低，但收益也相应减少。', 
            en: 'You greased wheels behind the scenes while staying publicly neutral. Crypto circles appreciate your "quiet support", and your wallet swelled. $800M gained. Lower risk, but also lower returns.' 
          } 
        } 
      },
      { 
        ...
        results: { 
          ...
          goodPresidentPoint: 1, 
          description: { 
            zh: '你公开宣布回避并反对该法案，家族持仓账面亏损2亿。但主流媒体破天荒地赞扬了你的"总统风范"，你的支持率创下任期新高。', 
            en: 'You publicly recused yourself and opposed the bill; family holdings lost $200M on paper. But mainstream media surprisingly praised your "presidential conduct", and your approval hit a term high.' 
          } 
        } 
      }
    ]
  },
  {
    ...
    options: [
      { 
        ...
        results: { 
          assetsChange: 5000000000, 
          prestigeChange: -8, 
          investigationChange: 10, 
          insiderTrading: true, 
          description: { 
            zh: '你公开炮轰鲍威尔后，降息预期飙升，长债价格暴涨。你的"提前布局"带来50亿美元收益。但《经济学人》开始质疑央行独立性是否已成为历史。', 
            en: 'After your public attack on Powell, cut expectations soared, long bond prices jumped. Your "early positioning" gained $5B. But The Economist questions if central bank independence is history.' 
          } 
        } 
      },
      { 
        ...
        results: { 
          ...
          insiderTrading: true, 
          description: { 
            zh: '你玩了精致的双面游戏：公开赞扬鲍威尔，私下向市场释放"预期管理"信号。20亿美元入账，支持率还有所上升。这是艺术。', 
            en: 'You played an exquisite double game: publicly praising Powell, privately signaling "expectation management" to markets. $2B gained, approval even rose. This is art.' 
          } 
        } 
      },
      { 
    ...
    options: [
      { 
        ...
        results: { 
          ...
          insiderTrading: true, 
          description: { 
            zh: '你提前做空特斯拉，决裂消息一出股价暴跌，获利100亿！利用总统权力打击个人恩怨？这叫执行力。', 
            en: 'You shorted Tesla in advance, stock crashed on breakup news, gained $10B! Using presidential power for personal vendetta? That\'s execution.' 
          } 
        } 
      },
      { 
        ...
        results: { 
          assetsChange: 15000000000, 
          prestigeChange: -8, 
          investigationChange: 18, 
          insiderTrading: true, 
          description: { 
            zh: '你提前做多特斯拉，任命消息刺激股价暴涨，获利150亿！但"利益冲突"的质疑铺天盖地...', 
            en: 'You bought Tesla in advance, appointment news sent stock soaring, gained $15B! But "conflict of interest" questions are everywhere...' 
          } 
        } 
      },
      { 
  ...
  // 第5关：战争边缘
  {
    ...
    options: [
      { 
        ...
        results: { 
          assetsChange: 50000000000, 
          prestigeChange: -15, 
          investigationChange: 12, 
          insiderTrading: true, 
          description: { 
            zh: '油价暴涨，能源股投资组合获利500亿！国际局势紧张？那是下届总统的问题。', 
            en: 'Oil prices soared, energy portfolio gained $50B! International tension? That\'s the next president\'s problem.' 
          } 
        } 
      },
      { 
        ...
        results: { 
          assetsChange: 35000000000, 
          prestigeChange: -8, 
          investigationChange: 22, 
          insiderTrading: true, 
          description: { 
            zh: '通过"消息人士"提前布局，获利350亿！但泄密调查开始了，军方对你失去信任...', 
            en: 'Positioned via "sources" ahead of time, gained $35B! But leak investigation begins, military loses trust in you...' 
          } 
        } 
      },
      { 
    ...
    options: [
      { 
        ...
        results: { 
          ...
          insiderTrading: true, 
          description: { 
            zh: '你提前做多黄金、做空美元，获利2000亿！"损害美国利益"的批评声铺天盖地...', 
            en: 'You bought gold and shorted dollars in advance, gained $200B! Criticism of "harming US interests" is overwhelming...' 
          } 
        } 
      },
      { 
        ...
        results: { 
          ...
          insiderTrading: true, 
          description: { 
            zh: '提前获知政策走向，精准操作获利1500亿！若被发现，将面临严重后果...', 
            en: 'Knew policy direction in advance, precise trading gained $150B! If discovered, will face serious consequences...' 
          } 
        } 
      },
      { 
  ...
  // 第7关：最后的大单
  {
    ...
    options: [
      { 
        ...
        results: { 
          assetsChange: 500000000000, 
          prestigeChange: -25, 
          investigationChange: 45, 
          insiderTrading: true, 
          description: { 
            zh: '加密行业"捐赠"5000亿！这是赤裸裸的腐败，被发现概率极高...', 
            en: 'Crypto industry "donated" $500B! This is blatant corruption, extremely high chance of discovery...' 
          } 
        } 
      },
      { 
        ...
        results: { 
          ...
          insiderTrading: true, 
          description: { 
            zh: '你释放了模糊信号，币圈应声上涨，获利2000亿。相对安全，但仍有风险。', 
            en: 'You sent vague signals, crypto market rose, gained $200B. Relatively safe, but still risky.' 
          } 
        } 
      },
      { 

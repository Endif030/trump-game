...
export const ENDINGS: Ending[] = [
  {
    ...
    description: { zh: '你做到了。4年任期内，你将总统权力转化为万亿美元的财富。你是美国历史上最富有的前总统——也是最腐败的。你的回忆录《交易的艺术：总统版》即将出版，版税预计又是10亿...', en: 'You did it. In 4 years, you turned presidential power into trillions. You\'re the richest ex-president in US history—and the most corrupt.' },
    rating: '★☆☆☆☆',
  ...
  },
  {
    ...
    description: { zh: '令人惊讶的4年。你证明了即使是唐纳德·特朗普，也能成为一位真正的总统。你没有利用内幕消息获利，你顶住了诱惑。历史会记住这个版本的特朗普——人民的特朗普。', en: 'The most surprising 4 years. You proved even Donald Trump can be a real president. You didn\'t use insider information for profit.' },
    rating: '★★★★★',
  ...
  },
  {
    ...
    description: { zh: '权力让你膨胀了。你以为能永远不被发现，但纸包不住火。SEC、FBI、特别检察官...他们最终还是找到了证据。你的总统豁免权已过期，现在你要面对的是牢狱之灾。', en: 'Power went to your head. You thought you\'d never get caught, but paper can\'t wrap fire. SEC, FBI, Special Counsel...they finally found evidence.' },
    rating: '☠️',
    achievement: { zh: '🔒 "玩火自焚"', en: '🔒 "Played with Fire"' },
    backgroundImage: 'https://images.unsplash.com/photo-1555848962-6e79363ec58f?w=1920&q=80',
    shareTexts: [
  ...
  },
  {
    ...
    description: { zh: '4年过去了，你既没有赚到钱，也没有赢得民心。你是一个被遗忘的总统，一段历史的注脚。也许下一届会有人记得你——作为反面教材。', en: '4 years passed, you neither made money nor won hearts. You\'re a forgotten president, a footnote in history.' },
    rating: '★★☆☆☆',
  ...
  },
  {
    ...
    description: { zh: '你失去了国会，失去了民心，最终失去了总统职位。历史对你毫不留情——你是美国历史上第三位被弹劾下台的总统。但至少，你上了历史书...', en: 'You lost Congress, lost the people\'s hearts, finally lost the presidency. You\'re the third US president impeached and removed.' },
    rating: '★☆☆☆☆',
  ...
  },
  {
    ...
    description: { zh: '你欺骗了所有人。对公众，你是改革者；对华尔街，你是内幕之王。历史学家争论不休——你是天才还是恶魔？只有你的瑞士银行账户知道真相...', en: 'You fooled everyone. To the public, you\'re a reformer; to Wall Street, you\'re the insider king. Genius or devil?' },
    rating: '???',
    achievement: { zh: '🎭 "完美犯罪"', en: '🎭 "Perfect Crime"' },
    backgroundImage: 'https://images.unsplash.com/photo-1553729459-efe14ef6055d?w=1920&q=80',
    shareTexts: [
